...
function blog_posts() {
    ...
    let posts = [
        {
            url: 'https://cidxb.blogspot.com/',
            title: 'New Opening of my blog',
        },
        // {
    ...
    for(let post of posts) {
        ...
        if(post.tags) {
            tags = post.tags.map(tag => {
                return `<a href="https://cidxb.blogspot.com/tags#${tag}">${tag}</a>`
            })
        }
    ...
    let post_template = `
    <div class="blog-post more-blogs" onclick="blog_link_click('https://cidxb.blogspot.com');">
